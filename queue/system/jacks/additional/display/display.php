<?php
    $counter = "SELECT user_name, current_queue FROM counters, users WHERE counters.counter_status = 'active' AND counters.user_id = users.user_id";
        ...
        <div class="container p-3">
            ...
            while ($row = $total_counters->fetch_assoc()) {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <p class="token"><?php echo $row['user_name'] ?></p>
                    </div>
                </div>
                <?php
            }
