<?php
    ...
    if($_SESSION['admin_id']){
        ...
        elseif($page_name == 'next_counter') {
            require 'jacks/additional/counters/nextCounter.php';
        }
        
        elseif($page_name == 'close_counter') {
            require 'jacks/additional/counters/closeCounter.php';
        }
